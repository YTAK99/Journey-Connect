...
@PostMapping("/{id}/permanent-delete") ApiResponse<AdminDtos.CommandResult> permanentDelete(@PathVariable long id,@RequestBody AdminDtos.PermanentDeleteRequest r){return ApiResponse.ok(service.permanentDelete(id,r));}}
